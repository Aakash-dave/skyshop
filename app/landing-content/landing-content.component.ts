...
import { LogonComponent } from '../logon/logon.component'; // dialog page
...
export class LandingContentComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this._products_ = this.dataService_.getProducts();


  }// ngOnInit

  openProduct() {
    this.route_.navigate(['/product']);
  }
